...
\draw[solid implication] (rect)--node[left,font=\tiny,align=right]{product-weight\\energy bound}(plain);
...
\draw[solid implication] (gram)--node[right,align=left]{energy\\bound}(smallrect);
