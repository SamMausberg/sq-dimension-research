\section{The order-median algorithm and proof}\label{app:proofs-C}
\begin{algorithm}[t]
...
\end{algorithm}
\input{figures/order_median}


\subsection[Proof of result median]{Proof of \cref{lem:median}}\label{proof:median}
...
\subsection[Proof of result fast]{Proof of \cref{thm:fast}}\label{proof:fast}
