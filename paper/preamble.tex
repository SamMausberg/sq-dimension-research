...
% Uncaptioned proof ledgers have separate counters and hyperlink destinations.
\newcounter{auditlongtable}
\makeatletter
\newenvironment{auditlongtable}{%
  \let\c@table\c@auditlongtable
  \renewcommand{\theHtable}{audit.\arabic{auditlongtable}}%
  \longtable
}{\endlongtable}
\makeatother
