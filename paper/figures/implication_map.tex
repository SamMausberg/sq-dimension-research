...
\draw[solid implication,<->] (rect)--node[above=2pt,align=center,font=\tiny]{Theorem\\\ref{thm:communication}}(comm);
...
\draw[solid implication] (joint)--node[above=2pt,align=center,font=\tiny]{Theorem\\\ref{thm:barrier}}(hard);
\draw[solid implication] (gram)--node[above=2pt,align=center,font=\tiny]{Theorem\\\ref{thm:barrier}}(hard);
